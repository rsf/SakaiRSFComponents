...
public class DummySearchService {
  ...
  private String[] searchValues = { "aaronz", "adam", "alan", "alexander",
      "allison", "amber", "andy", "anthony", "antranig", "anya", "apple",
      "ariel", "arnold", "azkaban", "catharine", "dan", "daniel", "emel",
      "guy", "harriet", "ian", "john", "katy", "matthew", "mike", "raad",
      "raymond", "rhiannon", "rob", "sarah", "stephanie", "steve", "sue",
      "sultan" };
